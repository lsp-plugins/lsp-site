...
<ul>
	...
	<li><b>FFT</b> - allows to select size of the FFT frame used for the processing. The larger FFT frame is, the more precise the curve is approximated and the more latency the plugin introduces</li>
